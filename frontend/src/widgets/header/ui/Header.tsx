            ...
            <div className="header__inner container">
                <div className="header__top">
                    ...
                    <div className="header__title hidden__mobile">
                        Всероссийский образовательный форум уличной<br />
                        культуры и спорта «Улицы России»
                    </div>
                </div>
                <div className="header__bottom">
                    ...
                    <nav className="header__nav">
                        <Link href="/#about" className="header__link" onClick={() => setIsMenuOpen(false)}>О нас</Link>
                        ...
                        <Link href="/#registration" className="header__link" onClick={() => setIsMenuOpen(false)}>Регистрация</Link>
                        <Link href="/#experts" className="header__link" onClick={() => setIsMenuOpen(false)}>Эксперты</Link>
                        <Link href="/#location" className="header__link" onClick={() => setIsMenuOpen(false)}>Локация</Link>
                        <Link href="/#partners" className="header__link" onClick={() => setIsMenuOpen(false)}>Партнеры и организаторы</Link>
                        <Link href="/#media" className="header__link" onClick={() => setIsMenuOpen(false)}>Аккредитация для СМИ</Link>
                    </nav>
                    <Button className="red compact">Участвовать</Button>
                </div>
            </div>
        </header>
    );
